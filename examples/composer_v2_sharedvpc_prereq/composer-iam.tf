...
locals {
  ...
  all_sa_list                        = concat(list(local.cloud_composer_service_account,local.cloud_services_service_account, local.services_container_service_account,local.host_container_service_account))
}
