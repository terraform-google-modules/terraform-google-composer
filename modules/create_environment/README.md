...
| network\_name | Name of network created for Cloud Composer Environment. | string | `"composer-network-01-04"` | no |
...
| subnet\_name | Name of subnetwork created for Cloud Composer Environment. | string | `"composer-subnet-01-04"` | no |
