...
| composer\_service\_account | Service Account for creating Cloud Composer. | string | n/a | yes |
...
| node\_count | Number of worker nodes in Cloud Composer Environment. | string | `"3"` | no |
